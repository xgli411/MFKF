...
import argparse
import cv2
from MFKF.FlahsPose.demo.lib.preprocess import h36m_coco_format, revise_kpts
import os 
import numpy as np
import torch
...
from MFKF.FlahsPose.common.model_poseformer import PoseTransformerV2 as Model
from MFKF.FlahsPose.common.camera import *

import matplotlib
import matplotlib.pyplot as plt 
from mpl_toolkits.mplot3d import Axes3D
import matplotlib.gridspec as gridspec
from MFKF.MambaPose.detect import detect as MambaPose
...
def get_pose2D(video_path, output_dir):
    ...
    print('\nGenerating 2D pose...')
    keypoints, scores = MambaPose(args)
...
def get_pose3D(video_path, output_dir):
    ...
    for i in tqdm(range(video_length)):
        ...
        # # 存储3D坐标点至coordinates_3d
        # coordinates_3d.append(post_out)
    ...
    np.save(output_dir + 'coordinates_3d.npy', np.array(coordinates_3d))
    print('3D coordinates saved successfully!')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--video', type=str, default='video (6).avi', help='input video')
    ...
    video_path = 'D:/duanxianlin/PoseFormerV21-main/PoseFormerV2-main/demo/video/' + args.video
    video_name = video_path.split('/')[-1].split('.')[0]
    output_dir = 'D:/duanxianlin/PoseFormerV21-main/PoseFormerV2-main/demo/output/' + video_name + '/'
